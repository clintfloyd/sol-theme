...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<section class="itemSection">
		<div class="entry-content">
			<div class="columns-3 cartContainer  cart woocommerce-cart-form__contents">
				...
				foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
					...
					$totalAmount += $cart_item['line_subtotal'];
					...
					if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
						...
						<li>
							...
							<div>
								...
								<small class="origPriceContainer">
								<?php
							...
							<div>
								...
								<div class="removeProdContainer">
									<?php
										echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
											'woocommerce_cart_item_remove_link',
											sprintf(
												'<a href="%s" class="" aria-label="%s" data-product_id="%s" data-product_sku="%s">Remove</a>',
				...
				<div class="noflex couponContainer">
...
<div class="cart-collaterals cart-collat">
	<?php
		/**
...
jQuery(function($){
	...
	$(document).on("keydown",".input-text.qty", function(){
	...
	$( document ).ajaxStop(function(){
		var html = $(".mainsubtotalcontainer").html();
	 	$(".cartTotalAmount").html(html);
	});
})
</script>

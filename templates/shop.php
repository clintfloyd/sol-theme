...
<article class="page">
	<header class="entry-header has-text-align-center header-footer-group">
		...
		<div class="entry-header-inner section-inner mediumj cart_header">
			<h3 class="entry-title">Your cart total is AED <?php echo number_format($total); ?></h3>
			<p>Free delivery on orders over AED 360.</p>
			<a href="./checkout" class="shop_checkout_cta">Checkout</a>
		</div><!-- .entry-header-inner -->

	</header>
	<section class="itemSection">
		<div class="entry-content">
			<div class="columns-3 cartContainer">
				<ul>
				<?php
				foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
